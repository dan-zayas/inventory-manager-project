...
// Create an interface for AddInventoryForm component props
interface AddInventoryFormProps extends FormModalProps {
  groups: GroupProps[];
}

// Create the AddInventoryForm functional component
const AddInventoryForm: FC<AddInventoryFormProps> = ({
  ...
  // Create a reference for file input element
  ...
  // Define the function to handle file change
  ...
  // Render the AddInventoryForm component
  return (
    <Modal
      ...
      <Form layout="vertical" onFinish={onSubmit} form={form}>
        <Form.Item label="Item Photo">
          <div
            className="imageView"
            onClick={() =>
              !loading && fileSelect.current?.click()
            }
            style={{
              backgroundImage: `url(${
                imageUrl ? imageUrl : ImageHolder
              })`,
            }}
          />
          <input
        ...
        <Form.Item
          ...
          name="total"
          rules={[
            { required: true, message: "Please input item count!" },
          ]}
        >
