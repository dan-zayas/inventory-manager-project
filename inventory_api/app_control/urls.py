...
from .views import (
    InventoryView, ClientView, SummmaryView, PurchaseView, SaleByClientView, InventoryGroupView, SalePerformanceView, InvoiceView, InventoryCSVLoaderView
)
...
router.register("summary", SummmaryView, "summary")
